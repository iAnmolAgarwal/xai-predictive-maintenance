...
``tests/fixtures/features/golden_spectral_bands.json`` was generated once from
:mod:`xpm.features.spectral` over the deterministic signals rebuilt by
:func:`_signals` below; regenerating it is a deliberate act, not a test fixup.
"""
...
from xpm.data.schema import IMS_BANDS_HZ, IMS_SAMPLE_RATE_HZ, IMS_SNAPSHOT_ROWS
